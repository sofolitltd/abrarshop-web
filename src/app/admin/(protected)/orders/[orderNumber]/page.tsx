...
import { Package, ArrowLeft, Calendar, MapPin, CreditCard, Phone, ShoppingBag } from "lucide-react";
...
export default async function AdminOrderDetailsPage({ params: paramsPromise }: { params: Promise<{ orderNumber: string }> }) {
